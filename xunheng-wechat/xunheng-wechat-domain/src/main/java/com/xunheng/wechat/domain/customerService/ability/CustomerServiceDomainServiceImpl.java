...
public class CustomerServiceDomainServiceImpl implements CustomerServiceDomainService {
     ...
     */
    @Override
    public boolean tryAutoReply(String appId, Integer exactMatch, String toUser, String keywords) {
        try {
            List<WoaReplyRuleEntity> rules = this.getMatchedRules(appId,exactMatch, keywords);
            if (rules.isEmpty()) {
                return false;
            }
            long delay = 0;
            for (WoaReplyRuleEntity rule : rules) {
    ...
    public void replyText(String toUser, String content) throws WxErrorException {
        ...
        woaMsgGateway.saveOrUpdate(WoaMsgEntity.buildOutMsg(WxConsts.KefuMsgType.TEXT,toUser,json));
    }
    ...
    public void replyImage(String toUser, String mediaId) throws WxErrorException {
        ...
        woaMsgGateway.saveOrUpdate(WoaMsgEntity.buildOutMsg(WxConsts.KefuMsgType.IMAGE,toUser,json));
    }
    ...
    public void replyVoice(String toUser, String mediaId) throws WxErrorException {
        ...
        JSONObject json = new JSONObject().fluentPut("mediaId",mediaId);
        woaMsgGateway.saveOrUpdate(WoaMsgEntity.buildOutMsg(WxConsts.KefuMsgType.VOICE,toUser,json));
    }
    ...
    public void replyVideo(String toUser, String mediaId) throws WxErrorException {
        ...
        JSONObject json = new JSONObject().fluentPut("mediaId",mediaId);
        woaMsgGateway.saveOrUpdate(WoaMsgEntity.buildOutMsg(WxConsts.KefuMsgType.VIDEO,toUser,json));
    }
    ...
    public void replyNews(String toUser, String newsInfoJson) throws WxErrorException {
        ...
        woaMsgGateway.saveOrUpdate(WoaMsgEntity.buildOutMsg(WxConsts.KefuMsgType.NEWS,toUser,JSON.parseObject(newsInfoJson)));
    }
    ...
    public void replyMpNews(String toUser, String mediaId) throws WxErrorException {
        ...
        JSONObject json = new JSONObject().fluentPut("mediaId",mediaId);
        woaMsgGateway.saveOrUpdate(WoaMsgEntity.buildOutMsg(WxConsts.KefuMsgType.MPNEWS,toUser,json));
    }
    ...
    public void replyWxCard(String toUser, String cardId) throws WxErrorException {
        ...
        woaMsgGateway.saveOrUpdate(WoaMsgEntity.buildOutMsg(WxConsts.KefuMsgType.WXCARD,toUser,json));
    }
    ...
    @Override
    public List<WoaReplyRuleEntity> getMatchedRules(String appId, Integer exactMatch, String keywords) {
        return null;
    }
}
