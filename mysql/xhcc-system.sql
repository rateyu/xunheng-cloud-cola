...
INSERT INTO `sys_permission` (`id`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `tenant_id`, `department_id`, `sub_company_id`, `name`, `type`, `title`, `path`, `component`, `icon`, `parent_id`, `sort_order`, `status`, `fullpage`) VALUES ('1482257207691223042', '682265633886208', '2022-01-15 15:43:52', '682265633886208', '2022-01-15 15:44:36', 0, '999', '999', '999', 'back-code-gen', 'menu', '后端代码生成', '/system/generator/back-code-gen', 'system/generator/back-code-gen', 'el-icon-notebook', '1482256966501965825', 0.00, 0, NULL);
