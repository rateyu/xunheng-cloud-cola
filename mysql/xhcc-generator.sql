...
-- ----------------------------
BEGIN;
INSERT INTO `g_gen_config` (`type`, `name`, `domain_name`, `description`, `author`, `table_prefix`, `table_alias`, `service_name`, `id`, `create_by`, `create_time`, `update_by`, `update_time`, `tenant_id`, `sub_company_id`, `department_id`) VALUES ('COLA', 'Test', 'test', '测试类', 'hhqkkr', 't_', 'te', 'test', '1676148128937164801', '682265633886208', '2023-07-04 16:37:10', '682265633886208', '2023-07-05 16:18:28', '999', '999', '999');
COMMIT;
