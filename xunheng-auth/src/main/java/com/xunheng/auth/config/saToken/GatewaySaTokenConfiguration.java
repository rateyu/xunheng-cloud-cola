package com.xunheng.auth.config.saToken;
...
import com.xunheng.auth.config.properties.IgnoredUrlsProperties;
import com.xunheng.base.exception.LoginDisableException;
        ...
        return new SaReactorFilter()
                ...
                .setError(e -> {
                    ...
                    if (e instanceof NotLoginException) {//如果是未登录异常
                        ...
                        message = "对不起，您没有当前权限！";
                    }else if(e instanceof LoginDisableException) {//如果是被封禁异常
                        message = "此账号禁止登录！";
